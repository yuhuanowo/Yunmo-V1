...
7. **config**：~166M（hidden 768 / layers 20 / heads 8 / kv 4 / head_dim 96 / vocab 24000）—— 對 MiniMind 只改深度 8→20、vocab 6400→24000
...
- pretrain 實際 token 數（估 ~2.6B：pretrain_t2t ~2.0B + wiki ~0.6B）
